...
def _func_lua_name(func: dict[str, Any]) -> str:
    name = func.get("name")
...
def _rule_name(func: dict[str, Any]) -> str:
    ...
    if not isinstance(path, list) or not path:
        raise TranslateError(f"function {_func_lua_name(func)} has no path")
    last = path[-1]
